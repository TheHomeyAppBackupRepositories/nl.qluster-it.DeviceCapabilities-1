(function(){
    ...
    var elifDirective = function(name, method, getter){
        ...
        'elif',
        '$parse',
        function($animate, $document, $injector, elif, $parse){
          ...
          return {
            ...
            link: function(scope, element, attrs, ctrls, transcludeFn){
              ...
              var previousElements;
                ...
                if(value){
                  if(attrs.execute) $parse(attrs.execute)(scope);
                  
                  // console.log(attrs.setModel);
                  // if(attrs.setModel!==undefined && attrs.ngModel)  {
                  //   console.log($parse(attrs.setModel)(scope));
                  //   let a = $parse(attrs.ngModel);
                  //   console.log();
                  //   $parse(attrs.ngModel).assign(scope,$parse(attrs.setModel)(scope));
                  // }
